...
oauth2_scheme = OAuth2PasswordBearer(tokenUrl=f"{settings.API_V1_STR}/auth/login/company") # Can be any of the login endpoints
...
def get_current_college(current_user: User = Depends(get_current_user)) -> User:
